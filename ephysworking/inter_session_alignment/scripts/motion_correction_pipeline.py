...
SESSIONS = ["ses-006_date-20231223_type-lse2", "ses-003_date-20231221_type-pretest"]  # ["1119617_LSE1_shank12_g0", "1119617_pretest1_shank12_g0", "1119617_posttest1_shank12_g0"]
...
if __name__ == "__main__":
    ...
    for ses in SESSIONS:
        ...
        pipeline_steps.save_motion_histograms(
            sub_path, ses
        )

        if ses != SESSIONS[0]:
            pipeline_steps.align_to_first_session(
                sub_path, SESSIONS[0], ses
            )

        pipeline_steps.save_data_plots(
            sub_path, ses
        )
